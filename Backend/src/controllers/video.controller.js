...
const getAllVideos = asyncHandler(async (req, res) => {
    ...
    .populate("owner", "username avatar fullName")      // this will change the owner field from _id to {_id, username, avatar, fullName} in response only not in database, so that we can use it for frontend without changing our video schema
